        ...
        <div class="center">
            <div class="contact-items">
                <div class="address-item">
                    <div class="info">
                        <span class="title-info">Наш адрес:</span>
                        ...
                        <span class="title-info">Время работы:</span>
                        ...
                        <span class="title-info">Представительство в Виннице:</span>
                        <a href="tel:+380937857822">тел. +38 093 785 78 22</a>
                        <a style="line-height: 23px" target="_blank" href="https://goo.gl/maps/aN6jGWtUN9Q2">ул. Оводова, 51 (Skypark), 5 этаж, <br> комната 3.405, языковая школа White Collar</a>
                        <a href="http://whitecollar.com.ua/" target="_blank">whitecollar.com.ua</a>
                    </div>
                    <div id="map"></div>
